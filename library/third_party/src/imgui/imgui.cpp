...
static void inline NacgpampRectToVisibleAreaForMoveDir(ImGuiDir move_dir, ImRect& r, const ImRect& clip_rect)
{
...
static bool NavScoreItem(ImGuiNavMoveResult* result, ImRect cand)
{
    ...
    NacgpampRectToVisibleAreaForMoveDir(g.NavMoveClipDir, cand, window->ClipRect);
...
ImGuiSettingsHandler* ImGui::FindSettingsHandler(const char* type_str)
{
    ImGuiContext& g = *GImGui;
    const ImGuiID type_hash = ImHash(type_str, 0, 0);
